...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private String busId = "bus_1"; // default aman
    ...
    private final LatLng checkpoint1011 = new LatLng(-7.274574959267352, 112.79783330254087);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (busId == null) busId = "bus_1"; // default aman
...
// ===== ARRIVAL LOGIC (20–30 m) =====
                if (distanceToTarget <= HALTE_RADIUS) {
                    ...
                    if (!hasArrived) {
                        ...
                        //currentTargetIndex = (currentTargetIndex + 1) % halte.length;
    ...
    private void sendToFirebase(Location loc, float speed, float distance, float bearing, int arrival) {
        ...
        //int halteAsalIndex = (currentTargetIndex - 1 + halte.length) % halte.length;
        //ref.child("halte_asal_id").setValue(halteAsalIndex + 1);
        //ref.child("halte_tujuan_id").setValue(currentTargetIndex + 1);
